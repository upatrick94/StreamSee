...
public class PlaylistController {
    ...
    @GetMapping("/{id}")
    public PlaylistResponse getPlaylist(@RequestHeader("X-User-Id") Long userId, @PathVariable long id) {
        authorizationService.ensurePermission(userId, "PLAYLIST_READ");
    ...
    public PlaylistResponse createPlaylist(@RequestHeader("X-User-Id") Long userId, @Valid @RequestBody PlaylistRequest request) {
        authorizationService.ensurePermission(userId, "PLAYLIST_WRITE");
    ...
    @PutMapping("/{id}")
    public PlaylistResponse updatePlaylist(@RequestHeader("X-User-Id") Long userId, @PathVariable long id, @Valid @RequestBody PlaylistRequest request) {
        authorizationService.ensurePermission(userId, "PLAYLIST_WRITE");
    ...
    public void deletePlaylist(@RequestHeader("X-User-Id") Long userId, @PathVariable long id) {
        authorizationService.ensurePermission(userId, "PLAYLIST_DELETE");
    ...
    public PlaylistResponse restoreHistoryEntry(@RequestHeader("X-User-Id") Long userId, @PathVariable long id, @PathVariable long historyEntryId) {
        authorizationService.ensurePermission(userId, "PLAYLIST_RESTORE");
